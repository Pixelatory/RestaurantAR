...
import UserCommentRating from './UserCommentRating';
...
export default function UserComment(){
	...
	const [userComment, onChangeText] = React.useState("");
	...
	return (
		...
		<View style={{backgroundColor: 'white', flex:1}}>
			...
			<View style={styles.commentContainer}>
				<TextInput style={styles.comment} onChangeText={onChangeText} value={userComment}/>
			</View>
